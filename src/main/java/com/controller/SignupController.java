...
public class SignupController {
	...
	public ModelAndView processSignupPage(UserModel userModel,ModelAndView mandv) {
		...
		try {
			...
			es.sendEmail(userModel.getEmail(), "Account Creation", "Your account for Spring HappyBuy Store have been created successfully..." + "Email: " + userModel.getEmail());

			} catch(Exception e) {
				System.out.println("Email not sent for signup" + e);
			}
